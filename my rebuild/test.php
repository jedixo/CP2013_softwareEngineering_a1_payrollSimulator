<?php
    ...
    elseif  ($_POST['submit'] == "Insert Entry") {
        ...
        $sql = "INSERT INTO employees (first_name, last_name, address, pay_type, pay_delivery, emp_union, salary, password, user_level) VALUES ('$_POST[f_name]', '$_POST[l_name]', '$_POST[address]', $_POST[pay_type], $_POST[pay_delivery], '$_POST[emp_union]', $_POST[salary], '$pass', 'user' )";
